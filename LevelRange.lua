...
LEVELRANGE_RANGES = {
    ...
    -- Turtle WoW Zones
    [LEVELRANGE_BALOR]                  = {29, 34, lTYPE_ALLIANCE},
    ...
    [LEVELRANGE_GRIMREACHES]            = {33, 38, lTYPE_ALLIANCE},
    [LEVELRANGE_LAPIDIS]                = {48, 53, lTYPE_CONTESTED},
    [LEVELRANGE_NORTHWIND]              = {28, 34, lTYPE_ALLIANCE},
...
LEVELRANGE_INSTANCES = {
    ...
    [LEVELRANGE_BALOR]              = {LEVELRANGE_STORMWROUGHRUINS, " (35-41)"},
...
LEVELRANGE_RAIDS = {
    ...
    [LEVELRANGE_BURNINGSTEPPE]      = {LEVELRANGE_MOLTENCORE, " (60+)", LEVELRANGE_BLACKWINGLAIR, " (60+)"},  
    [LEVELRANGE_SEARINGGORGE]       = {LEVELRANGE_MOLTENCORE, " (60+)", LEVELRANGE_BLACKWINGLAIR, " (60+)"},
    
    -- Turtle WoW Raids
    [LEVELRANGE_HYJAL]              = {LEVELRANGE_EMERALDSANCTUM, " (60+)"},
    [LEVELRANGE_DEADWINDPASS]       = {LEVELRANGE_LOWERKARAZHANHALLS, " (58-60)", LEVELRANGE_TOWEROFKARAZHAN, " (60+)"},
};
